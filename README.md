...
This repository provides the official code release for our published paper:
...
- **IEEE Xplore**: [Selective and Noise-Resistant Virtual Point Cloud Fusion for Long-Range 3D Object Detection](https://ieeexplore.ieee.org/document/11503424/)
- **DOI**: `10.1109/OJVT.2026.3689631`
...
If you find this project useful, please cite both the upstream VirConv work and our published paper.
...
@ARTICLE{11503424,
  ...
  number={},
  pages={1399-1412},
  keywords={Feeds;Filtering;Filters;Central Processing Unit;Circuits and systems;LoRa;Location awareness;Mobile communication;Pixel;Protocols;3D object detection;LiDAR point clouds;virtual point clouds;depth completion;multimodal fusion;cross-attention;long-range perception},
  doi={10.1109/OJVT.2026.3689631}
}
```
